...
insert into groups (ID, groupname, permission) values (1,'STUDENT', 1);
insert into groups (ID, groupname, permission) values (2,'TEACHER',3);
insert into groups (ID, groupname, permission) values (3,'ADMIN',7);
