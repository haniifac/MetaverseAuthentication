...
insert into groups (ID, groupname, role_binary) values (NEXTVAL('GROUP_SEQ'),'STUDENT', 1);
insert into groups (ID, groupname, role_binary) values (NEXTVAL('GROUP_SEQ'),'TEACHER',2);
insert into groups (ID, groupname, role_binary) values (NEXTVAL('GROUP_SEQ'),'ADMIN',4);
